...
export const flutterPackages: FlutterPackage[] = [
  {
    ...
    description:
      "A predictable state management library that helps implement the BLoC (Business Logic Component) design pattern. It provides a robust way to separate business logic from UI, making apps more testable and maintainable.",
    ...
    codeSnippets: [
      {
        ...
        description:
          "Simple example showing events, states, and bloc implementation",
        language: "dart",
        code: `// Events
  ...
  builder: (context, count) {
    return Text('$count');
      ...
      },
      {
        ...
        description:
          "Real-world example with loading, success, and error states",
        language: "dart",
        code: `// States
...
class UserBloc extends Bloc<UserEvent, UserState> {
  ...
  UserBloc(this.repository) : super(UserInitial()) {
    ...
    personalTake:
      "BLoC is my go-to for production apps. The initial setup takes more time, but it pays off massively in maintainability and testing. I've used it in 15+ projects and it consistently delivers predictable, scalable architecture. Perfect for apps that will grow over time.",
    bestPractices: [
  ...
  },
  {
    ...
    description:
      "A powerful HTTP client for Dart with support for interceptors, global configuration, FormData, request cancellation, file downloading, timeout, and more. My preferred choice for all API communication.",
...
dio.interceptors.add(InterceptorsWrapper(
  ...
  Future<void> uploadFile(File file) async {
    ...
    personalTake:
      "Dio is indispensable for any app with API communication. The interceptor system alone makes it worth using. I've handled everything from simple REST calls to complex file uploads with authentication refresh. It's reliable, feature-rich, and well-maintained.",
    bestPractices: [
  ...
  },
  {
    ...
    description:
      "Flutter plugin for reading and writing simple key-value pairs to persistent storage. Perfect for storing user preferences, settings, and small amounts of data.",
...
await prefs.clear();`,
  ...
  Future<ThemeMode> getTheme() async {
    ...
    personalTake:
      "Perfect for what it does - simple, persistent storage. I use it in every single project for user preferences and settings. Don't try to make it do more than it's designed for - use Hive or SQLite for complex data.",
    bestPractices: [
  ...
  },
  {
    ...
    description:
      "A wrapper around InheritedWidget to make state management easier and more reusable. Recommended by the Flutter team for simple to medium complexity apps.",
...
final count = context.watch<CounterProvider>().count;`,
    ...
    personalTake:
      "Provider is my choice for MVPs and smaller projects. It's quick to set up and gets the job done. For production apps with complex logic, I prefer BLoC, but Provider is perfect for prototyping.",
    bestPractices: [
  ...
  },
  {
    ...
    description:
      "A composable, Future-based library for making HTTP requests. Great for simple REST integrations where you want minimal overhead.",
...
Future<void> createPost(Map<String, dynamic> payload) async {
  ...
  if (res.statusCode == 201) {
    ...
    personalTake:
      "Ideal when you want something simple without the overhead of interceptors. I often start with http for MVPs and switch to Dio if requirements grow (auth refresh, logging, retries).",
